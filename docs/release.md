...
`0.1.0-alpha.5`. The same `v<version>` tag publishes the Rust crate and every
...
git checkout -b release/v0.1.0-alpha.5
just release-prep 0.1.0-alpha.5
```
...
```sh
just release-check 0.1.0-alpha.5
just release-package-dry-run 0.1.0-alpha.5
```
