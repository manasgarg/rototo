...
`0.1.0-alpha.4`. The same `v<version>` tag publishes the Rust crate and every
...
just release-prep 0.1.0-alpha.4
```
...
```sh
just release-check 0.1.0-alpha.4
just release-package-dry-run 0.1.0-alpha.4
```
