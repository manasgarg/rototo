...
use crate::diagnostics::{
    CustomRuleDefinition, CustomRuleId, DiagnosticLocation, DiagnosticRule, DocId, LintDiagnostic,
...
pub(super) fn document_symbols(index: &SemanticIndex, path: &str) -> Vec<WorkspaceDocumentSymbol> {
...
pub(super) fn completion_items(index: &SemanticIndex, path: &str) -> Vec<WorkspaceCompletionItem> {
