...
export function MeProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <MeContext.Provider value={{ me, error, loading, reload }}>{children}</MeContext.Provider>
  );
}
...
export function useShellUser(): { githubLogin: string; githubAvatarUrl: string | null } {
  const { me } = useMe();
  return {
