        ...
        <div className="graph-frame">
            ...
            {hasEntities ? (
                ...
                <div className="graph-empty hint">
                    No graph entities are declared in this workspace.
                </div>
            )}
        </div>
    );
...
function partitionGraph(data: WorkspaceGraphData): {
    components: WorkspaceGraphData[];
    isolated: GraphNode[];
} {
    ...
    const components: WorkspaceGraphData[] = [];
