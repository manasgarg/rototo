...
export function DraftScreen({
  ...
  const entityExtras = useApi<DraftEntityData>(
    selectedEntityPath ? `${base}/entity?path=${encodeURIComponent(selectedEntityPath)}` : null,
  );
  ...
  const contextPreviews: EditContextPreview[] = entityExtras.data?.contextPreviews ?? [];
